/**
 * Compact 4-state status disc used in member-row lists (set
 * navigator popover, sets sidebar, ticket queues, …).
 *
 * Generic by design — the disc only knows about the four visual
 * **tones**; mapping a domain's state machine onto those tones is
 * the caller's job. That keeps the same glyph usable for curation
 * reviews (untouched / draft / uncommitted / done), ticket queues
 ...
 *
 * The two filled tones differentiate by colour alone, not by fill
