  ...
  return (
    ...
    >
        ...
        className={
          sidebarOpen
            ? // ``h-`` (not ``max-h-``) so the sticky aside fills
              ...
              // Fixed-height flex column: the header chrome stays pinned
      ...
      >
        ...
        {sidebarOpen ? (
          // Inner scroll box — the panel's cards scroll here while the
          // aside (and its full-height resize gutter) stay put.
          <div className="lg:flex-1 lg:min-h-0 lg:overflow-y-auto lg:pb-24">
            {sidebarView === "audit" ? (
