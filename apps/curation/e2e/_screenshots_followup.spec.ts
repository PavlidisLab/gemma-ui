...
test("dashboard — tickets section close-up @live", async ({ page }) => {
  await page.goto("/");
...
test("EE 8895 (GSE31160) — opened from ticket chip @live", async ({ page }) => {
