 ...
 *
 * Lives in ``@gemma/ui`` so both apps share one implementation; the
 * old per-app ``components/ui/Spinner.tsx`` files re-export from
 * here as a thin shim (keeps the many existing import paths
